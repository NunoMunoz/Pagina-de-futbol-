<template>
  <div class="about">
    <v-container>
      ...
      <v-container>
        <h3 class="text-md-center">Northside Youth Soccer League</h3>
        <h4 class="text-md-center">RULES OF PLAY & POLICIES</h4>
        ...
        <ol>
          <li type="square">
            ...
            whose behavior detracts fromo this purpose is subject to
        ...
        <ol>
          <li>
            ...
            external field dimensions within a given maximun and minimum width
          ...
          <ul>
            <li type="a">Recreation & District Programs</li>
            <ol>
              <li type="square">
                ...
                touchline and extending to twenty yards (20) both ways from the
                halfway line. In the event that field 2 conditions require team
                benches to be on the same side of the field, a team's bench area
                shall consist of that area two(2) yards away from the touchline
                and extending twenty yards one (1) way from the halfway line.
              </li>
              <li type="square">
                ...
                within their bench area during the game. Parents and spectators
                should occupy the same side of the field as the team they are
                supporting.
              </li>
            </ol>
            <li type="a">State Competition League Only</li>
            <ol>
              <li type="square">
                ...
                and substitutes must remain within their team's bench area
                during the game.
              </li>
              <li type="square">
                Parents and spectators must occupy the sideline opposite the
                team bench areas. Supporters of a team must assemble on the side
                of the midfield facing the team bench area of that team. There
                shall be a buffer zone extending ten yards on each side of the
                midfield that may not be occupied by parents or spectators.
                Match officials shall be empowered to enforce these provisions
                and may suspend or terminate games in the event that any team,
                coach, parent, or spectator declines to abide by requests from
        ...
        <ol>
          <li type="square">
            <strong>Team Size.</strong> Except as noted below, below, team
            rosters shall consist of not less than eleven nor more than eighteen
            ...
            game. No more than eleven (11) players per team may be on the field
            at any one time during the game.
          </li>
          <li type="square">
            <strong>SIZE OF AGE GROUP TEAMS.</strong>In order to give player's
            maximum opportunity to develop in the game of soccer, U-6 through
            U-1O play modified rules and size of roster as stated in United
            States Youth Soccer Association (USYSA) rules. It is strongly
            recommended that U-6 and U-8 play 4 v 4. UYSA shall not sanction
            games involving teams under 10 or younger unless such games are
            conducted with not more than eight (8) players per side. (National
            rule 4036 section 2)
          </li>
          <li type="square">
        ...
        <ol>
          ...
          <ol>
            <li type="1">Prior to a throw-in your favor.</li>
            <li type="1">Prior to a goalkick by either team.</li>
            <li type="1">After a goal by either team.</li>
            <li type="1">
              After an injury, by either team, when the referee stops play.
            </li>
            <li type="1">At half time.</li>
            <li type="1">
        ...
        <ol>
          <li type="square">
            <strong>GIRLS PLAYING ON BOYS' TEAMS.</strong> Girls are eligible to
        ...
        <ol>
          <li type="square">
            ...
            orappeal, shall be subject to the following conditions:
          </li>
          <ol>
            <li type="1">
              The game shall be replayed on the same field, as was the suspended
